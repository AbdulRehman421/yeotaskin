...
class OrderHistoryCard2 extends StatefulWidget {
  final ProductModel cartProduct;
  const OrderHistoryCard2(
      {super.key,
        required this.cartProduct,});

  @override
  State<OrderHistoryCard2> createState() => _OrderHistoryCard2State();
}

class _OrderHistoryCard2State extends State<OrderHistoryCard2> {
